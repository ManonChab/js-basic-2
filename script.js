...
if (age >= 18) {
    ...
    print = "No eres aún mayor de edad";
}
console.log(print);
...
let result1 = typeof value

if (result1 == "string") {
    print = "Es un string"
} else if (result1 == "number"){
    print = "Es un número"
} else {
    print = "No es ni número ni string"
}
console.log(print);
...
function saludar (nombre) {
    return console.log("Hola, mi nombre es "+nombre);
}
...
calcularAreaRectangulo (37, 12);
calcularAreaRectangulo (46, 16);
